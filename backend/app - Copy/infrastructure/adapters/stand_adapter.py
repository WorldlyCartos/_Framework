...
def orm_to_domain_stand(orm_stand: ORMStand) -> DomainStand:
    return DomainStand(orm_stand.stand_oid, orm_stand.od_object_type, stand_parts=[orm_to_domain_stand_part(part) for part in orm_stand.stand_parts])
...
def domain_stand_to_orm(domain_stand: DomainStand) -> ORMStand:
    """
    ...
    return ORMStand(
        stand_oid=domain_stand.stand_oid,
        od_object_type=domain_stand.od_object_type,
        stand_parts=[domain_to_orm_stand_part(part) for part in domain_stand.stand_parts],
    )
...
def domain_to_orm_stand_part(domain_stand_part: DomainStandPart) -> ORMStandPart:
    ...
    return ORMStandPart(
        ...
        effective_date=domain_stand_part.effective_date,
        expiry_date=domain_stand_part.expiry_date,
        stand_attribute_children=[domain_to_orm_stand_attributes(attr) for attr in domain_stand_part.stand_attributes],
    )
